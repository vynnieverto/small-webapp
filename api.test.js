...
describe('getPlayer integration tests', () => {
    ...
    beforeAll(async () => {
        ...
        await request(BASE_URL).post('/api/getPlayer').send({ gameName: 'RocketEscape', tagLine: 'GLHF', platform: 'na1' })
    });
    ...
    describe('POST /api/getPlayer with already queried player', () =>{
        it('should return existing player data', async () => {
            const response = await request(BASE_URL)
                .post('/api/getPlayer')
                .send({ gameName: 'RocketEscape', tagLine: 'GLHF', platform: 'na1' }); // Replace with actual PUUID for testing
    ...
    describe('POST /api/getPlayer with new player', () => {
        it('should create a new player and return the data', async () => {
            const response = await request(BASE_URL)
                .post('/api/getPlayer')
                .send({ gameName: gameName1, tagLine: tagLine1, platform: 'na1' });
            ...
            expect(response.body.playerData).toHaveProperty('Region', 'na1'); // Check if platform is present
        });
    });
    ...
    describe('POST /api/getPlayer with no data', () => {
        it('should return an error for empty player data', async () => {
            const response = await request(BASE_URL)
                .post('/api/getPlayer')
                .send({ gameName: '', tagLine: '', platform: 'na1' });
    ...
    describe('POST /api/getPlayer with invalid platform', () => {
        it('should return an error for invalid platform', async () => {
            const response = await request(BASE_URL)
                .post('/api/getPlayer')
                .send({ gameName: gameName1, tagLine: tagLine1, platform: 'invalidplatform' });
    ...
    describe('POST /api/getPlayer with no game name', () => {
        it('should return an error for invalid game name', async () => {
            const response = await request(BASE_URL)
                .post('/api/getPlayer')
                .send({ gameName: '', tagLine: tagLine1, platform: 'na1' });
    ...
    describe('POST /api/getPlayer with no tag line', () => {
        it('should return an error for invalid tag line', async () => {
            const response = await request(BASE_URL)
                .post('/api/getPlayer')
                .send({ gameName: gameName1, tagLine: '', platform: 'na1' });
...
// describe('[player]/Mastery integration tests', () => {
//     const PUUID1 = null; // Initialize PUUID variable
//     const tagLine1 = 'GLHF'; // 
//     const gameName1 = 'CorruptCosmonaut'; // 
...
//         // intialize the database with a player
//         await request(BASE_URL).post('/api/getPlayer').send({ gameName: 'RocketEscape', tagLine: 'GLHF', platform: 'na1' })
//         await request(BASE_URL).get('/api/RocketEscape-GLHF/Mastery').send({ gameName: 'RocketEscape', tagLine: 'GLHF', platform: 'na1' })
//         await request(BASE_URL).post('/api/getPlayer').send({ gameName: gameName1, tagLine: tagLine1, platform: 'na1' })
...
//     describe('GET /api/player/mastery with no platform', () => {
//         it('should return an error for invalid platform', async () => {
//             const response = await request(BASE_URL)
//                 .get('/api/RocketEscape-GLHF/Mastery')
...
// describe('[player]/MatchHistory integration tests', () => {
//     const PUUID1 = null; // Initialize PUUID variable
//     const tagLine1 = 'GLHF'; // 
//     const gameName1 = 'CorruptCosmonaut'; // 
...
//         // intialize the database with a player
//         await request(BASE_URL).post('api/getPlayer').send({ gameName: 'RocketEscape', tagLine: 'GLHF', platform: 'na1' })
//         await request(BASE_URL).get('api/RocketEscape#GLHF/MatchHistory').send({ gameName: 'RocketEscape', tagLine: 'GLHF', platform: 'na1' })
//         await request(BASE_URL).post('api/getPlayer').send({ gameName: gameName1, tagLine: tagLine1, platform: 'na1' })
